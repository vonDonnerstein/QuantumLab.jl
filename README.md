...
`Linux/Mac`: [![Build Status](https://travis-ci.org/vonDonnerstein/QuantumLab.svg)](https://travis-ci.org/vonDonnerstein/QuantumLab) `Win`: [![Build Status](https://ci.appveyor.com/api/projects/status/github/vonDonnerstein/QuantumLab?branch=master&svg=true)](https://ci.appveyor.com/project/vonDonnerstein/quantumlab) `Test Coverage`: [![Coverage Status](https://coveralls.io/repos/vonDonnerstein/QuantumLab.jl/badge.svg?branch=master&service=github)](https://coveralls.io/github/vonDonnerstein/QuantumLab.jl?branch=master)

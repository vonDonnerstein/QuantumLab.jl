...
INFO("SETTING UP VARIABLES FOR FURTHER TESTING")
indent="=> "
include("setup.jl")
...
INFO("TESTING:   DocumentationModule")
docModTester() = 1
@doc """
some markdown documentation
""" docModTester
@test typeof(@doc(docModTester)) == Markdown.MD
@doc ["""
some markdown documentation
""",
GenericCitation("generic citation"),
BookCitation(["C. Darwin"], "On the Origin of Species", "978-0451529060"),
JournalCitation(["M. Mustermann"],"J. Stup. Mistakes",1,12,2016),
] docModTester
@test typeof(@doc(docModTester)) == Vector{DocumentationModule.Documentation}
@test isa([Markdown.parse("Hellau!"),BookCitation(["C. Darwin"], "On the Origin of Species", "978-0451529060")],Vector{DocumentationModule.Documentation})
@test isa([Markdown.parse("Hellau!"),JournalCitation(["M. Mustermann"],"J. Stup. Mistakes",1,12,2016)],Vector{DocumentationModule.Documentation})
@test isa([Markdown.parse("Hellau!"),DocumentationModule.Documentation(BookCitation(["C. Darwin"], "On the Origin of Species", "978-0451529060"))],Vector{DocumentationModule.Documentation})
...
# test BaseModule
mqns = collect(MQuantumNumbers(LQuantumNumber("D")))
@test typeof(mqns) == Vector{MQuantumNumber}
@test mqns[end] == MQuantumNumber(0,0,2)
...
INFO("TESTING:   InitialGuessModule")
@test -0.264689 ≈ (sum(matrixSADguess)/2)[3,2] atol=1e-6
@test_throws ErrorException computeDensityGuessSAD("NotImplemented","STO-3G",h2o)



# test HartreeFockModule
INFO("TESTING:   HartreeFock (bas, h2o, density)")
...
INFO("TESTING:   Shells/LibInt2Shells/Basis equivalence")
...
shell_nativefromlibint2 = convert(Shell,shell_libint2)
...
display([Markdown.parse("**Why, god, why??**"),BookCitation(["C. Darwin"], "On the Origin of Species", "978-0451529060"), JournalCitation(["M. Mustermann"],"J. Stup. Mistakes",1,12,2016)])

...
@test_approx_eq_eps -74.96178985 (evaluateSCF(bas,h2o,density,5,info=false,detailedinfo=false)[2] + computeEnergyInteratomicRepulsion(h2o)) 1e-7 # checked against FermiONs++
